...
import com.example.dhc.customviews.SupplementItem
...
class BuyFragment : Fragment() {
    ...
    private fun listLayoutProcessing(view: View?) {
        ...
        var counselingItem: SupplementItem = view!!.findViewById(R.id.counselingItem)
        ...
        var examItem: SupplementItem = view.findViewById(R.id.examItem)
        examItem.setOnClickListener{
            replaceFragment(MedicalExamFragment.newInstance());
        }

        // Inflate create item and its click listener
        var issueItem: SupplementItem = view.findViewById(R.id.issueItem)
        issueItem.setOnClickListener{
            replaceFragment(PersonalTaskFragment.newInstance());
        }

        // Inflate test item and its click listener
        var testItem: SupplementItem = view.findViewById(R.id.testItem)
        ...
        var ingredientItem: SupplementItem = view.findViewById(R.id.ingredientItem)
    ...
    private fun purchasedHistoryProcessing(view: View?) {
        ...
        if (purchasedHistory) {
            ...
            buyAgainBtnView.setOnClickListener{
                replaceFragment(PurchasedHistoryFragment.newInstance());
            }
        }
        else {
